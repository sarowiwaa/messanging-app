...
<body class="d-flex justify-content-center align-items-center vh-100">
    <div class="w-400 shadow p-4 rounded">
        ...
        <div class="d-flex align-items-center">
            <img src="uploads/<?=$chatWith['p_p']?>" class="w-15 rounded-circle" alt="Profile Picture">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#sendBtn').on('click', function() {
                ...
                if (message == "") return;
                $.post("app/ajax/insert.php", { message: message, to_id: <?=$chatWith['user_id']?> }, function(data) {
                    $('#message').val("");
                    $('#chatBox').append(data);
                    scrollDown();
                });
